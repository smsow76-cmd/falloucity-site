...
# ===== BIENS =====
BIENS = [
    {'id': 1, 'titre': 'Immeuble Horizon', 'details': 'Immeuble avec parking', 'image': 'house1.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
    {'id': 2, 'titre': 'Résidence Soleil', 'details': 'Immeuble avec ascenseur', 'image': 'house2.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
    {'id': 3, 'titre': 'Immeuble Élégance', 'details': 'Immeuble avec balcon', 'image': 'house3.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
    {'id': 4, 'titre': 'Immeuble Prestige', 'details': 'Immeuble avec parking sécurisé', 'image': 'house4.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
    ...
    {'id': 6, 'titre': 'Immeuble Palmier', 'details': 'Immeuble avec balcon et terrasse', 'image': 'house6.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
    {'id': 7, 'titre': 'Résidence Standing', 'details': 'Immeuble avec grande terrasse', 'image': 'house7.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
    ...
    {'id': 10, 'titre': 'Immeuble Panorama', 'details': 'Immeuble avec espace extérieur', 'image': 'house10.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
    ...
    {'id': 23, 'titre': 'Résidence Elite', 'details': 'Immeuble avec grande terrasse et sécurité', 'image': 'house23.jpeg', 'type_bien': 'Immeuble', 'lieu': 'Ngor-Almadies'},
